    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <div class="pull-right">
                <button type="submit" data-toggle="tooltip" id="album_save" name="album_save" class="btn btn-primary" title="{LANG.save}">
        ...
        <div class="panel-body">
            <form action="" method="post" enctype="multipart/form-data" id="album-add" class="form-horizontal">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab-general">
                        <ul class="glt-upload-step clearfix">
                            <li class="active"><span class="stepicon"><span>&nbsp;</span></span> <span class="steptext">Bước 1: Tạo Album</span></li>
                            <li><span class="stepicon"><span>&nbsp;</span></span> <span class="steptext">Bước 2: Chọn và tải ảnh</span></li>
                            <li><span class="stepicon"><span>&nbsp;</span></span> <span class="steptext">Bước 3: Cập nhật thông tin ảnh</span></li>
                        </ul>
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-20">
                                ...
                                <!-- BEGIN: error_folder-->
                                <div class="text-danger">{error_folder}</div>
                                <!-- END: error_folder -->
                    ...
                    <div class="tab-pane" id="tab-image">
                        <ul class="glt-upload-step clearfix">
                            <li><span class="stepicon"><span>&nbsp;</span></span> <span class="steptext">{LANG.album_step_1}</span></li>
                            <li class="active"><span class="stepicon"><span>&nbsp;</span></span> <span class="steptext">{LANG.album_step_2}</span></li>
                            <li><span class="stepicon"><span>&nbsp;</span></span> <span class="steptext">{LANG.album_step_3}</span></li>
                        </ul>
                    ...
                    <div class="tab-pane" id="tab-info-image">
                        <ul class="glt-upload-step clearfix">
                            <li><span class="stepicon"><span>&nbsp;</span></span> <span class="steptext">{LANG.album_step_1}</span></li>
                            <li><span class="stepicon"><span>&nbsp;</span></span> <span class="steptext">{LANG.album_step_2}</span></li>
                            <li class="active"><span class="stepicon"><span>&nbsp;</span></span> <span class="steptext">{LANG.album_step_3}</span></li>
                        </ul>
                        <div class="clear"></div>
                                ...
                                <div id="images-{PHOTO.key}" class="col-sm-12 col-md-6">
                                    <div class="table-responsive row">
                                        <table class="table table-striped table-bordered table-hover">
                                            <tbody>
                                                <tr>
                                                    <td class="col-md-2"><input type="hidden" name="albums[{PHOTO.key}][row_id]" value="{PHOTO.row_id}"> <input type="hidden" name="albums[{PHOTO.key}][basename]" value="{PHOTO.basename}"> <input type="hidden" name="albums[{PHOTO.key}][filePath]" value="{PHOTO.filePath}"> <input type="hidden" name="albums[{PHOTO.key}][image_url]" value="{PHOTO.image_url}"> <input type="hidden" name="albums[{PHOTO.key}][thumb]" value="{PHOTO.thumb}"> <a href="{PHOTO.image_url}" rel="shadowbox[miss]" class="glt-upload2-thumb"> <span><img src="{PHOTO.thumb}" width="90"></span>
                                                    </a></td>
                                                    <td class="col-md-10 control"><label class="labelradio"><input type="radio" name="albums[{PHOTO.key}][defaults]" value="1" class="form-control fixradio"{PHOTO.defaults}> {LANG.defaults}</label> <label class="labelradio fr deleterows" data-toggle="tooltip" title="{LANG.delete}" data-row="{PHOTO.row_id}" data-token="{PHOTO.token}" data-token-image="{PHOTO.token_image}" data-token-thumb="{PHOTO.token_thumb}" data-key="{PHOTO.key}"> <i class="fa fa-spinner fa-lg  fa-spin"></i> <i class="fa fa-trash-o fa-lg fixtrash"></i>
                                                    </label> <input type="text" name="albums[{PHOTO.key}][name]" value="{PHOTO.name}" class="form-control" placeholder="{LANG.photo_name}"> <input type="text" name="albums[{PHOTO.key}][description]" value="{PHOTO.description}" class="form-control" placeholder="{LANG.photo_description}"></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                ...
                <div align="center">
                    <input type="hidden" name="album_id" value="{DATA.album_id}" /> <input name="action" type="hidden" value="add" /> <input name="save" type="hidden" value="1" />
