    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <div class="pull-right">
                <button type="submit" form="form-stock" data-toggle="tooltip" id="photos-setting-save" name="photos-setting-save" class="btn btn-primary" title="{LANG.save}"><i class="fa fa-save"></i>
