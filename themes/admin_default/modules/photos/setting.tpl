    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title" style="float: left">
                <i class="fa fa-pencil"></i>&nbsp;{LANG.setting}
            </h3>
            <div class="pull-right">
                <button type="submit" form="form-stock" data-toggle="tooltip" id="photos-setting-save" name="photos-setting-save" class="btn btn-primary" title="{LANG.save}">
        ...
        <div class="panel-body">
            <form action="" method="post" enctype="multipart/form-data" id="setting-form" class="form-horizontal">
                <input type="hidden" value="1" name="savesetting" /> <input type="hidden" name="{NV_NAME_VARIABLE}" value="{MODULE_NAME}" /> <input type="hidden" name="{NV_OP_VARIABLE}" value="{OP}" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-18 col-md-18">
                        <input class="form-control w100 pull-left" type="text" value="{DATA.origin_size_width}" name="origin_size_width" maxlength="4" /> <span class="pull-left text-middle">&nbsp;x&nbsp;</span> <input class="form-control pull-left w100" type="text" value="{DATA.origin_size_height}" name="origin_size_height" maxlength="4" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-18 col-md-18">
                        <input class="form-control w50 pull-left" type="text" value="{DATA.cr_thumb_width}" name="cr_thumb_width" maxlength="3" /> <span class="pull-left text-middle">&nbsp;x&nbsp;</span><input class="form-control pull-left w50" type="text" value="{DATA.cr_thumb_height}" name="cr_thumb_height" maxlength="3" /> <span class="pull-left text-middle">&nbsp;&nbsp;&nbsp;{LANG.setting_cr_thumb_quality}&nbsp;</span> <input class="form-control w50" type="text" value="{DATA.cr_thumb_quality}" name="cr_thumb_quality" maxlength="2" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-18">
                        <span class="text-middle pull-left"> {LANG.setting_autologowidth} &nbsp;</span> <input type="text" class="form-control w50 pull-left" value="{DATA.autologosize1}" maxlength="2" name="autologosize1"><span class="text-middle">&nbsp; % </span>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-6 control-label">{LANG.setting_autologosize2}:</label>
                    <div class="col-sm-18">
                        <span class="text-middle pull-left"> {LANG.setting_autologowidth} &nbsp;</span> <input type="text" class="form-control pull-left w50" value="{DATA.autologosize2}" maxlength="2" name="autologosize2" /><span class="text-middle pull-left">&nbsp; % </span>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-6 control-label">{LANG.setting_autologosize3}:</label>
                    <div class="col-sm-18">
                        <span class="text-middle pull-left"> {LANG.setting_autologosample}&nbsp;</span> <input type="text" class="form-control pull-left w50" value="{DATA.autologosize3}" maxlength="2" name="autologosize3" />&nbsp;<span class="text-middle pull-left">&nbsp; % </span>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-18">
                        <select class="form-control w250" name="maxupload">
                            ...
                            <!-- END: size1 -->
                        </select> ({LANG.setting_sys_max_size}: {SYS_MAX_SIZE})
                    </div>
                </div>
            </form>
