    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title" style="float: left">
                <i class="fa fa-list"></i> {LANG.album_list}
            </h3>
                ...
                <div class="row">
                    <form action="{NV_BASE_ADMINURL}index.php" method="get">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group col-md-8">
                                <button type="submit" id="button-filter" class="btn btn-primary pull-right" data-toggle="tooltip" title="{LANG.search}">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr id="group_{LOOP.album_id}">
                                ...
                                <td class="text-left"><a href="{LOOP.link}"> <strong>{LOOP.name}</strong></a> <a href="{LOOP.link_out}" target="_blank"><i class="fa fa-external-link"></i></a></td>
                                <td class="text-center">{LOOP.author_upload}</td>
                                <td class="text-center"><a href="{LOOP.category_link}">{LOOP.category}</a> <a href="{LOOP.category_link_out}" target="_blank"><i class="fa fa-external-link"></i></a></td>
                                <td align="center">{LOOP.num_photo}</td>
                                <td class="text-center"><select class="form-control" id="id_status_{LOOP.album_id}" onchange="nv_change_album('{LOOP.album_id}','status');">
                                        <!-- BEGIN: status -->
                                        <option value="{STATUS.key}"{STATUS.selected}>{STATUS.name}</option>
                                        <!-- END: status -->
                                </select></td>
                                <td align="center">{LOOP.date_added}</td>
                                <td class="text-center"><a href="{LOOP.edit}" data-toggle="tooltip" title="{LANG.edit}" class="btn btn-primary"><i class="fa fa-pencil"></i></a> &nbsp;&nbsp; <a href="javascript:void(0);" onclick="delete_album('{LOOP.album_id}', '{LOOP.token}')" data-toggle="tooltip" title="{LANG.delete}" class="btn btn-danger"><i class="fa fa-trash-o"></i></td>
                            </tr>
                            <!-- END: loop -->
                        </tbody>
                    </table>
