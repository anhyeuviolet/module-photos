...
<div class="page-header pd10_0 mg0_0_10">
    ...
    <span class="text-muted">{LANG.category}:&nbsp;</span><a href="{CATALOG.link}" title="{CATALOG.name}">{CATALOG.name}</a> <span><i class="fa spacer"></i></span> <span class="text-muted">{LANG.album_author_upload}: {ALBUM.author_upload}</span> <span><i class="fa spacer"></i></span> <span class="text-muted">{LANG.viewed}: {ALBUM.viewed}</span>
</div>
<!-- BEGIN: description -->
<hr />
        ...
        <div class="col-xs-24 col-sm-12 col-md-{PER_LINE} col-lg-{PER_LINE}">
            <div class="panel panel-default">
                <div class="panel-body pd5">
                    <a href="{PHOTO.file}" title="{ALBUM.name}({PHOTO.num}/{ALBUM.num_photo})" data-gallery="gallery"> <img class="lazy img-responsive center-block" data-original="{PHOTO.thumb}" src="{PHOTO.thumb}" alt="{PHOTO.name}" width="640" height="480" />
                    </a>
                </div>
                <div class="panel-footer view_detail pd5">
                    <span class="text-muted"><em class="fa fa-eye"></em>&nbsp;{PHOTO.viewed}</span> <a href="{PHOTO.link_img}" class="btn btn-primary pull-right"><i class="fa fa-picture-o"></i>&nbsp;{LANG.view_image}</a>
                </div>
            </div>
        </div>
        <!-- END: loop_img -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left prev">
                        <i class="fa fa-chevron-left"></i> {LANG.view_previous}
                    </button>
                    <button type="button" class="btn btn-primary next">
                        {LANG.view_next} <i class="fa fa-chevron-right"></i>
                    </button>
                </div>
            </div>
        </div>
...
<!-- BEGIN: generate_page -->
<div id="generate_page" class="text-center">{GENERATE_PAGE}</div>
<!-- END: generate_page -->
...
<div id="other-album" class="row">
    ...
    <div class="col-xs-24 col-sm-12 col-md-{PER_LINE} col-lg-{PER_LINE}">
        <div class="panel panel-default">
            <div class="panel-body pd5">
                <a href="{OTHER.link}" title="{OTHER.name}"> <img class="lazy img-responsive center-block" data-original="{OTHER.thumb}" src="{OTHER.thumb}" alt="{OTHER.name}" width="640" height="480" />
                </a>
            </div>
            <div class="panel-footer view_detail pd5">
                <div class="album-name">
                    <h3>
                        <a title="{OTHER.name}" href="{OTHER.link}">{OTHER.name}</a>
                    </h3>
                </div>
                <div class="clear"></div>
                <span class="text-muted"><em class="fa fa-eye"></em>&nbsp;{OTHER.viewed}</span> <a href="{OTHER.link}" class="btn btn-primary pull-right"><i class="fa fa-picture-o"></i>&nbsp;{LANG.view_album}</a>
            </div>
        </div>
    </div>
    <!-- END: loop_album -->
