...
<div class="col-md-24 col-sm-24 col-xs-24">
    <div class="page-header pd10_0 mg0_10_10">
        ...
        <span class="text-muted">{LANG.album}:&nbsp;</span><a href="{ALBUM.link}" title="{ALBUM.name}">{ALBUM.name}</a> <i class="fa spacer"></i> <span class="text-muted">{LANG.viewed}:&nbsp;{PHOTO.viewed}</span>
    </div>
</div>
<div id="view_image_{PHOTO.row_id}" class="col-md-24 col-sm-24 col-xs-24">
    ...
    <div class="col-md-24 col-sm-24 col-xs-24">
        <div id="photo-{PHOTO.row_id}">
            <a href="{PHOTO.file}" title="{PHOTO.title}" data-gallery="gallery"> <img class="img-responsive center-block" src="{PHOTO.file}" alt="{PHOTO.title}" />
            </a>
        </div>
    </div>
    <!-- BEGIN: next -->
...
<noscript>
    <div class="row">
        <div class="col-md-24 col-sm-24 col-xs-24">
            <div class="page-header pd10_0 mg0_10_10">
                <h3 class="txt20 txt_bold">
                    <span class="pd5">{PHOTO.name}</span>
                </h3>
        ...
        <div id="view_image_{PHOTO.row_id}" class="col-md-24 col-sm-24 col-xs-24">
            ...
            <div class="col-md-24 col-sm-24 col-xs-24">
                <div id="photo-{PHOTO.row_id}">
                    <a href="{PHOTO.file}" title="{PHOTO.name}" data-gallery="gallery"> <img alt="{PHOTO.name}" title="{PHOTO.name}" src="{PHOTO.file}" class="img-thumbnail" />
                    </a>
                </div>
            </div>
            <!-- BEGIN: next -->
