    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <h3 class="text-center">
                <em class="fa fa-search">&nbsp;</em>{LANG.info_title}
            </h3>
            <hr />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-17">
                    <div class="input-group">
                        <input type="text" class="form-control" name="from_date" id="from_date" value="{FROM_DATE}" readonly="readonly" /> <span class="input-group-btn">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-17">
                    <div class="input-group">
                        <input type="text" class="form-control" name="to_date" id="to_date" value="{TO_DATE}" readonly="readonly" /> <span class="input-group-btn">
    ...
    <div class="panel-body">
        ...
        <div class="clear">
            ...
            <div class="text-justify col-sm-24">
                <p>
                    <!-- BEGIN: result_img -->
                    <a href="{LINK}"> <img src="{IMG_SRC}" class="img-thumbnail pull-left" width="120px" />
                    </a>
                    <!-- END: result_img -->
                    {CONTENT}
                </p>
                <div class="clear"></div>
                <p class="text-justify text-muted">{TIME}</p>
            </div>
        </div>
        <hr />
        <!-- END: result -->
