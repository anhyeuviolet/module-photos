...
<div class="photo-detail" id="{BLOCK_ID}">
    <span class="pull-left"><strong>{LANG.album_model}</strong>:&nbsp;</span>
    <h3>{DATA.name}</h3>
    <div class="clear"></div>
    <!-- BEGIN: model -->
    ...
    <div class="panel-body">
        <form id="form3B" action="">
            <div class="h5 clearfix">
                <p>{STRINGRATING}</p>
                <!-- BEGIN: data_rating -->
                <span itemscope itemtype="http://data-vocabulary.org/Review-aggregate">{LANG.rating_average}: <span itemprop="rating">{REVIEWCOUNT}</span> - <span itemprop="votes">{RATINGCOUNT}</span> {LANG.rating_count}
                </span>
                <!-- END: data_rating -->
